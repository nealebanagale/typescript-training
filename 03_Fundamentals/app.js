...
function totalLengthInference(x, y) {
    var total = x.length + y.lenth; //TypeScript isn't even able to offer us the most basic static typing protection for warning (mis-splled property name, like length)
    return total;
}
//Specifying JavsScript types
function totalLengthTypes(x, y) {
