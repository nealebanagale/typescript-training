...
import '//code.jquery.com/jquery-1.12.1.min.js';       //loads jquert before this module gets loaded
declare var $: any;

export default class TodoListComponent {        //default export this module
    private $el: jQuery;            //jquery error (use typings for declaration file): but app can run because TS only generates the JS files used 
